...
impl Default for EditOptions {
	fn default() -> Self { Self { overwrite:true, store_name:false } }
}
...
impl<'s> Chunk<'s> {
	pub fn new(span:Span) -> Self { Self { span, ..Default::default() } }
}
...
impl<'str> Chunk<'str> {
	...
	pub fn is_edited(&self) -> bool { self.edited_content.is_some() }
}
